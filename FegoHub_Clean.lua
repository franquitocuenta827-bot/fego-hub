...
local old = playerGui:FindFirstChild("FegoHub_V3"); if old then old:Destroy() end
local gui_sg = Instance.new("ScreenGui"); gui_sg.Name = "FegoHub_V3"; gui_sg.ResetOnSpawn = false; gui_sg.IgnoreGuiInset = true; gui_sg.DisplayOrder = 9999999; gui_sg.Parent = playerGui
...
Themes = {
    Light = {
        ...
        Panel=Color3.fromRGB(250,240,255), Row=Color3.fromRGB(245,235,250), RowHover=Color3.fromRGB(240,228,248),
        Accent=Color3.fromRGB(160,70,220), AccentLight=Color3.fromRGB(180,100,240),
        Green=Color3.fromRGB(170,80,230), Red=Color3.fromRGB(200,120,240), Red2=Color3.fromRGB(140,55,200),
        Text=Color3.fromRGB(190,100,230), Dim=Color3.fromRGB(170,130,200), Stroke=Color3.fromRGB(210,160,255),
        SoftButton=Color3.fromRGB(240,225,250), SoftButtonHover=Color3.fromRGB(235,215,245),
        SoftAccent=Color3.fromRGB(230,200,245), SoftAccentHover=Color3.fromRGB(225,190,240),
        ToggleOff=Color3.fromRGB(240,220,250), ToggleOff2=Color3.fromRGB(245,225,250),
        InputBg=Color3.fromRGB(255,255,255), SliderBg=Color3.fromRGB(200,160,230),
        BlacklistHover=Color3.fromRGB(240,200,245), BlacklistLeave=Color3.fromRGB(245,225,250),
    },
    Dark = {
        ...
        Accent=Color3.fromRGB(160,70,220), AccentLight=Color3.fromRGB(180,100,240),
        Green=Color3.fromRGB(170,80,230), Red=Color3.fromRGB(200,120,240), Red2=Color3.fromRGB(140,55,200),
        Text=Color3.fromRGB(255,255,255), Dim=Color3.fromRGB(200,200,200), Stroke=Color3.fromRGB(50,30,65),
        SoftButton=Color3.fromRGB(35,25,45), SoftButtonHover=Color3.fromRGB(45,30,55),
        SoftAccent=Color3.fromRGB(50,35,65), SoftAccentHover=Color3.fromRGB(60,40,75),
        ToggleOff=Color3.fromRGB(35,25,45), ToggleOff2=Color3.fromRGB(35,25,45),
        InputBg=Color3.fromRGB(30,22,38), SliderBg=Color3.fromRGB(50,35,60),
        BlacklistHover=Color3.fromRGB(80,30,60), BlacklistLeave=Color3.fromRGB(45,30,55),
    }
}
Theme = {}
...
function applyTheme(themeName)
    ...
    local function updateBottomBarTheme()
        ...
        for _, child in ipairs(bottomBar:GetChildren()) do
            ...
            elseif child:IsA("TextLabel") then
                if child.Text == "FEGO HUB" or child.Text == "|" or child.Text == "discord.gg/fegohub" then
    ...
    pcall(function()
        local sg = playerGui:FindFirstChild("FegoHub_V3")
...
-- CONFIG (merged)
local CONFIG_FILE = "fego_hub_config.json"
local PS_CODE_FILE = "fego_hub_pscode.txt"
PrivateServerCode = ""
...
local function createProxAPRing()
    ...
    r.Transparency = 0.8
    r.Color = Color3.fromRGB(160, 70, 220)
...
local STEALBAR = {
    ...
    GLOW = Color3.fromRGB(160, 70, 220),
    TRACK = Color3.fromRGB(55, 40, 50),
    TRACK2 = Color3.fromRGB(35, 30, 35),
    FILL1 = Color3.fromRGB(180, 100, 240),
    FILL2 = Color3.fromRGB(160, 70, 220),
}
    ...
    local ok, err = pcall(function()
        ...
        local signPart = getClosestBaseSign(targetPart)
            ...
            if isSecondFloor then
                ...
                plat.Color = Color3.fromRGB(160, 70, 220)
...
ctapHighlight.FillColor=Color3.fromRGB(200,130,255); ctapHighlight.FillTransparency=0.3
ctapHighlight.OutlineColor=Color3.fromRGB(200,130,255); ctapHighlight.OutlineTransparency=0
...
do
    ...
    local BEAM_COLOR   = Color3.fromRGB(200, 50, 255)   -- pink (line to best brainrot)
...
function makeHeader(f,t,isMain) local h=Instance.new("Frame"); h.Size=UDim2.new(1,0,0,42); h.BackgroundTransparency=1; h.Parent=f
    ...
    if isMain then local l=Instance.new("TextLabel"); l.Size=UDim2.new(1,-50,0,24); l.Position=UDim2.new(0,13,0,8); l.BackgroundTransparency=1; l.Text=parts[1] or "FEGO HUB"; l.TextColor3=Theme.Text; l.Font=Enum.Font.GothamBlack; l.TextSize=16; l.TextXAlignment=Enum.TextXAlignment.Left; l.Parent=h
    else local l=Instance.new("TextLabel"); l.Size=UDim2.new(1,-58,0,16); l.Position=UDim2.new(0,12,0,7); l.BackgroundTransparency=1; l.Text=parts[1] or "FEGO HUB"; l.TextColor3=Theme.Text; l.Font=Enum.Font.GothamBlack; l.TextSize=12; l.TextXAlignment=Enum.TextXAlignment.Center; l.Parent=h
...
function makeMainPanel(t,size,pos) local f=Instance.new("Frame"); f.Size=size; f.Position=pos; f.BackgroundColor3=Theme.MainBackground; f.BackgroundTransparency=0.06; f.BorderSizePixel=0; f.ClipsDescendants=true; f.Parent=gui; corner(f,12); addOutline(f); makeHeader(f,t,true)
    ...
    makeResizable(f, UDim2.new(0, 200, 0, 150), t)
    local mb=Instance.new("TextButton"); mb.Size=UDim2.new(0,18,0,18); mb.Position=UDim2.new(1,-24,0,4); mb.BackgroundColor3=Theme.Accent; mb.Text="-"; mb.TextColor3=Color3.new(1,1,1); mb.Font=Enum.Font.GothamBlack; mb.TextSize=14; mb.AutoButtonColor=false; mb.Parent=f; corner(mb,4)
    local fullSz; mb.MouseButton1Click:Connect(function() if body.Visible then fullSz=f.Size; f.Size=UDim2.new(f.Size.X.Scale,f.Size.X.Offset,0,42); body.Visible=false; mb.Text="+" else f.Size=fullSz; body.Visible=true; mb.Text="-" end end)
    return f,body end
...
function makeQuickPanel(t,size,pos) local f=Instance.new("Frame"); f.Size=size; f.Position=pos; f.BackgroundColor3=Theme.Background; f.BackgroundTransparency=0.04; f.BorderSizePixel=0; f.ClipsDescendants=true; f.Parent=gui; corner(f,12); addOutline(f); makeHeader(f,t,false)
    ...
    lay:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function() body.CanvasSize=UDim2.new(0,0,0,lay.AbsoluteContentSize.Y+10) end); 
    if Config.sizes and Config.sizes[t] then f.Size = UDim2.new(0, Config.sizes[t].x, 0, Config.sizes[t].y) end
    if not string.find(t, "Admin Command Panel") then makeResizable(f, UDim2.new(0, 150, 0, 150), t) end
    local mb=Instance.new("TextButton"); mb.Size=UDim2.new(0,18,0,18); mb.Position=UDim2.new(1,-24,0,4); mb.BackgroundColor3=Theme.Accent; mb.Text="-"; mb.TextColor3=Color3.new(1,1,1); mb.Font=Enum.Font.GothamBlack; mb.TextSize=14; mb.AutoButtonColor=false; mb.Parent=f; corner(mb,4)
    local fullSz; mb.MouseButton1Click:Connect(function() if body.Visible then fullSz=f.Size; f.Size=UDim2.new(f.Size.X.Scale,f.Size.X.Offset,0,42); body.Visible=false; mb.Text="+" else f.Size=fullSz; body.Visible=true; mb.Text="-" end end)
    return f,body end
...
local lg=Instance.new("TextLabel"); lg.Size=UDim2.new(0,150,0,26); lg.Position=UDim2.new(0,54,0,5); lg.BackgroundTransparency=1; lg.Text="FEGO HUB"; lg.TextColor3=Theme.AccentLight; lg.Font=Enum.Font.GothamBlack; lg.TextSize=19; lg.TextXAlignment=Enum.TextXAlignment.Left; lg.Parent=bottomBar
...
local dc=Instance.new("TextLabel"); dc.Size=UDim2.new(0,210,0,26); dc.Position=UDim2.new(0,230,0,5); dc.BackgroundTransparency=1; dc.Text="discord.gg/fegohub"; dc.TextColor3=Theme.AccentLight; dc.Font=Enum.Font.GothamBold; dc.TextSize=16; dc.TextXAlignment=Enum.TextXAlignment.Left; dc.Parent=bottomBar
local sb=Instance.new("TextLabel"); sb.Size=UDim2.new(0,290,0,14); sb.Position=UDim2.new(0,55,0,30); sb.BackgroundTransparency=1; sb.Text="Dev Lukitas"; sb.TextColor3=Theme.Dim; sb.Font=Enum.Font.GothamSemibold; sb.TextSize=10; sb.TextXAlignment=Enum.TextXAlignment.Left; sb.Parent=bottomBar
